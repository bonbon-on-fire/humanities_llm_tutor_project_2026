...
def _setup_debug_logger() -> logging.Logger:
    """Create (or retrieve) the file-based JSONL logger for GPT judge debug events."""
...
def _require_openai_api_key() -> str:
    """Return the OpenAI API key from the environment or raise JudgeError if absent."""
...
def _build_openai_model(*, model_name: str, api_key: str):
    """Create a ChatOpenAI instance, applying JUDGE_OPENAI_REASONING_EFFORT if supported."""
